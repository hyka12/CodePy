...
| $$    $$| $$  | $$| $$  | $$| $$_____/| $$      | $$  | $$
|  $$$$$$/|  $$$$$$/|  $$$$$$$|  $$$$$$$| $$      |  $$$$$$$
 \\______/  \\______/  \\_______/ \\_______/|__/       \\____  $$
                                                   /$$  | $$
                                                  |  $$$$$$/
                                                   \\______/  
"""
...
for arg_i in range(len(sys.argv)):
    if sys.argv[arg_i] == "--full-reset" or sys.argv[arg_i] == "-fr":
        print("\nresetting all exercises...\n")

        for exercise_i in range(len(exercises)):
            shutil.copy(reset_paths[exercise_i], exercise_paths[exercise_i])
